    ...
    def moveDatabase(self, temporaryFilePath, finalFilePath, Key, Bucket):
        if os.path.exists(finalFilePath):
            ...
            try:
                ...
                self.logger.error(f'Error deleting JSON file: {e} : Key: {Key}, Bucket: {Bucket}')
            ...
            try:
                ...
                self.logger.error(f'Error deleting final file: {e} : Key: {Key}, Bucket: {Bucket}')
                return
            ...
            try:
                ...
                self.logger.error(f'Error moving file:: {e} : Key: {Key}, Bucket: {Bucket}')
                return
